...
const tipoVehiculo = tipoVehiculoSelect.options[tipoVehiculoSelect.selectedIndex].text;
...
alert("No fue posible procesar el registro. Intenta nuevamente.");
}
});
...
const modalContent = registrationModal.querySelector(".form-message__content span");
const reserveButton = registrationModal.querySelector(".button--reserve");
/* Cliente nuevo registrado correctamente. */
if (resultado.registro_exitoso === true && resultado.cliente_creado === true) {
modalTitle.textContent = "¡Registro exitoso!";
modalContent.textContent = "Tus datos han sido guardados. Ahora puedes apartar tu servicio directamente en el lavadero.";
reserveButton.href = resultado.whatsapp_link || "https://w.app/milavaderoco";
reserveButton.textContent = "Reservar cupo";
}
/* Cliente que ya estaba registrado. */
else if (resultado.cliente_existente === true) {
modalTitle.textContent = "Ud ya está registrado";
modalContent.textContent = resultado.detalle || "Esta placa y teléfono ya están registrados.";
reserveButton.href = "https://w.app/milavaderoco";
reserveButton.textContent = "Reservar cupo";
}
/* Respuesta inesperada de n8n. */
else {
modalTitle.textContent = "No fue posible completar el registro";
modalContent.textContent = resultado.detalle || resultado.mensaje || "Intenta nuevamente.";
reserveButton.href = "https://w.app/milavaderoco";
reserveButton.textContent = "Reservar cupo";
}
/* Abre el modal. */
